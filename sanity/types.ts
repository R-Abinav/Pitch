...
// Query: *[_type == "startup" && defined(slug.current) && !defined($search) || title match $search || category match $search || author->name match $search] | order(_createdAt desc) {  _id,  _type,  _updatedAt,  _rev,  title,  slug,  _createdAt,  author -> {    _id,    name,    image,    bio  },  views,  description,  category,  image}
...
// Variable: AUTHOR_STARTUPS
// Query: *[_type == "startup" && author._ref == $id] | order(_createdAt desc) {  _id,  _type,  _updatedAt,  _rev,  title,  slug,  _createdAt,  author -> {    _id,    name,    image,    bio  },  views,  description,  category,  image}
export type AUTHOR_STARTUPSResult = Array<{
  _id: string;
  _type: "startup";
  _updatedAt: string;
  _rev: string;
